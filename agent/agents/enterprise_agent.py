...
class EnterpriseAgent:
    ...
    def __init__(self) -> None:
        ...
        self.metadata = get_metadata_json()
    ...
    def handle(self, question: str) -> dict[str, Any]:
        ...
        try:
            ...
            if "报告" in question:
                return {
                    "type": "agent",
                    "result": self.sql_agent.ask_with_report(AgentQuestion(question=question)),
                }

            return {
                "type": "agent",
                "result": self.sql_agent.ask(AgentQuestion(question=question)),
            }
